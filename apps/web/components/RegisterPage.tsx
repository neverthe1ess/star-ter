  ...
  return (
    <AuthLayout>
       <div className="w-[37%] flex flex-col items-center">
           ...
           <div className="w-38 h-38 mx-auto relative flex items-center justify-center">
            <div className="relative w-full h-full flex items-center justify-center">
              <svg viewBox="-10 -10 120 120" className="w-full h-full drop-shadow-md">
                <defs>
                  <linearGradient id="hexagonGradientRegister" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <path 
                  ...
                  fill="url(#hexagonGradientRegister)" 
                  stroke="url(#hexagonGradientRegister)"
                  strokeWidth="15"
              ...
              <div className="absolute w-[72%] h-[72%] bg-white rounded-full flex items-center justify-center shadow-inner">
                 {/* Checkmark Icon */}
                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="url(#checkmarkGradientRegister)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                  <defs>
                     <linearGradient id="checkmarkGradientRegister" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#65439f00" />
                        <stop offset="20%" stopColor="#65439fff" />
                        <stop offset="80%" stopColor="#090647ff" />
                        <stop offset="100%" stopColor="#09064700" />
                     </linearGradient>
                  </defs>
         ...
         <form onSubmit={handleRegister} className="w-full space-y-5">
           <div className="space-y-4">
             ...
             <div className="relative flex items-end gap-3">
                <User className="absolute left-0 bottom-3.5 w-4 h-4 text-slate-400" />
                <Input
                   id="nickname"
                   type="text"
         ...
         <div className="mt-8 w-full flex justify-between items-center text-xs font-semibold text-gray-500 px-2">
          </div>
       </div>
    </AuthLayout>
  );
