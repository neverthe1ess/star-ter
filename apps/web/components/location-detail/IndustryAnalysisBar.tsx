    ...
    <div className="absolute bottom-10 left-0 right-0 z-20 flex justify-center px-4 pointer-events-none">
      ...
      {isOpen ? (
        ...
        <div className="w-full max-w-[480px] bg-white/40 backdrop-blur-2xl rounded-[40px] p-6 shadow-2xl border border-white/40 pointer-events-auto animate-spring-up ring-1 ring-black/5">
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-3xl bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/20">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                </svg>
              </div>
              <div>
                <p className="text-gray-900 font-heading text-h4 leading-tight">
                  {selectedCategoryName} 분석
                </p>
                <p className="text-indigo-600 text-body font-strong mt-0.5">
                  이 상권의 경쟁 현황
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            <div className="bg-white/50 rounded-2xl p-4 text-center">
              <p className="text-gray-500 text-tiny font-strong mb-1">
                점포 수
              </p>
              <p className="text-gray-900 text-h2 font-heading">
                {storeCount}개
              </p>
            </div>
            <div className="bg-red-50/80 rounded-2xl p-4 text-center">
              ...
              <p className="text-red-600 text-h2 font-heading">
                {hotspotCount}곳
              </p>
            </div>
            <div className="bg-violet-50/80 rounded-2xl p-4 text-center">
              ...
              <p className="text-violet-600 text-h2 font-heading">
                ⭐ {recommendScore}
              </p>
            </div>
          </div>
          ...
          {/* 분석 요약 메시지 */}
          <div className="bg-linear-to-r from-indigo-50 to-violet-50 rounded-2xl p-4 border border-indigo-100/50">
            <p className="text-gray-700 text-body leading-relaxed font-bold">
        ...
        >
          ...
          <div className="w-12 h-12 rounded-full bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/30 group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="flex flex-col items-start">
            <span className="text-gray-900 font-heading text-h3 leading-none mb-1">
              경쟁 분석
            </span>
            <span className="text-indigo-600 text-body font-medium">
              {selectedCategoryName} {storeCount}개
              {hotspotCount > 0 ? ` · 과열 ${hotspotCount}곳` : ''}
            </span>
          </div>
