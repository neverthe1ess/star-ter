        ...
        <div className="w-full max-w-[420px] bg-white/40 backdrop-blur-2xl rounded-[40px] p-6 shadow-2xl border border-white/40 pointer-events-auto animate-spring-up ring-1 ring-black/5">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-3xl bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
              ...
              <div>
                ...
                <p className="text-blue-600 text-body font-medium mt-0.5">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/30 rounded-3xl p-4 border border-white/50 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <span className="text-gray-600 text-h4 font-heading tracking-wide">
                  보증금
                </span>
                <span className="text-blue-700 text-body font-bold bg-blue-100/50 px-3 py-1.5 rounded-xl">
              ...
              <div className="relative h-3 bg-gray-200/60 rounded-full mx-2">
                <div
                  className="absolute h-full bg-linear-to-r from-blue-200 to-blue-600 rounded-full opacity-90"
                  style={{
            ...
            <div className="bg-white/30 rounded-3xl p-4 border border-white/50 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-orange-600 text-body font-bold bg-rose-100 px-3 py-1.5 rounded-xl">
              ...
              <div className="relative h-3 bg-gray-200/60 rounded-full mx-2">
                <div
                  className="absolute h-full bg-linear-to-r from-orange-200 to-orange-500 rounded-full opacity-90"
                  style={{
