      ...
      <div className="w-screen h-screen flex items-center justify-center px-4 relative bg-muted/30">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10 w-full max-w-[1200px]">
          ...
          <div className="relative">
            ...
            <div className="bg-background p-3 rounded-[2.5rem] shadow-2xl border border-border overflow-hidden group">
              <div className="relative h-[480px] rounded-4xl overflow-hidden">
                ...
                <div className="absolute top-6 left-6 right-6 flex justify-between items-start">
                  <div className="bg-white/90 backdrop-blur px-4 py-2 rounded-xl shadow-lg border border-white/20">
                    <div className="text-caption font-strong text-foreground flex items-center gap-1.5">
                ...
                <div className="absolute bottom-6 left-6 right-6 grid grid-cols-2 gap-3">
                  <div className="bg-white/90 backdrop-blur p-4 rounded-2xl shadow-lg border border-white/20">
                    <div className="text-tiny text-muted-foreground mb-1">
                      일 평균 유동인구
                    </div>
                    <div className="text-body font-bold text-foreground">
                      142,500명
                    </div>
                    <div className="text-tiny text-success font-bold">
                      ▲ 12.4%
                    </div>
                  </div>
                  <div className="bg-white/90 backdrop-blur p-4 rounded-2xl shadow-lg border border-white/20">
                    ...
                    <div className="text-tiny text-info font-bold">
                      신뢰도 98% 분석 완료
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute top-1/2 left-1/3 -translate-y-1/2">
                  <div className="relative">
                    <div className="w-12 h-12 bg-destructive/20 rounded-full flex items-center justify-center animate-ping"></div>
